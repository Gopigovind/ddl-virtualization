  ...
  var Breadcrumb = function (_super) {
    ...
    Breadcrumb.prototype.initPvtProps = function () {
      ...
      if (this.overflowMode === 'Menu' && this._maxItems > 0) {
        ...
        this.endIndex = this.startIndex + this.items.length - this._maxItems;
      ...
      if (itemsLength) {
        ...
        for (var i = 0; i < len; i % 2 && j_1++, i++) {
          ...
          if (isCollasped && i > 1 && i < len - 2) {
            ...
            continue;
          } //else if (this.overflowMode === 'Menu' && j >= this.startIndex && (j < this.endIndex && (i % 2 ? !(j === this.endIndex - 1) : true))) {
          //continue;
          //}
          ...
          if (this.overflowMode === 'Menu' && j_1 >= this.startIndex && j_1 < this.endIndex && (i % 2 ? !(j_1 === this.endIndex - 1) : true)) {
            if (i % 2) {
              continue;
            } else {
          ...
          //.childNodes, (this.overflowMode === 'Wrap' && i === 0) ? firstOl : this.overflowMode === 'Wrap' ? wrapDiv : ol);
          ...
          if (this.overflowMode === 'Menu' && this.startIndex === i) {
            var li = this.createElement('li', {
    ...
    Breadcrumb.prototype.clickHandler = function (e) {
      ...
      if (li && (sf.base.closest(e.target, '.' + ITEMTEXTCLASS) || this.itemTemplate)) {
        ...
        if (this.overflowMode === 'Menu' && idx > [].slice.call(this.element.children[0].children).indexOf(this.element.querySelector('.e-breadcrumb-menu'))) {
